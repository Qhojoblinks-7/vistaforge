...
const PortfolioPage = () => {
    ...
    // Use server-provided projects only (server is the source of truth)
    const sourceProjects = transformedProjects;
                            ...
                            <div className="flex items-start justify-between">
                                <div className="flex-1 min-w-0">
                                    <h3 className="font-bold text-[#0015AA] text-3xl">
                                        {sourceProjects[activeProjectIndex]?.name || sourceProjects[activeProjectIndex]?.title}
                                    </h3>
                        ...
                        {loading ? (
                            ...
                            sourceProjects.map((project, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="rounded-xl bg-gray-50 opacity-70 hover:opacity-100 transition-all duration-300 cursor-pointer h-64 flex flex-col p-4 md:p-6 group shadow-lg hover:shadow-xl animate-fade-in-up"
                                        onClick={() => handleProjectClick(index)}
                                    >
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 min-w-0">
                        ...
                        <div className="p-8">
                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <p className="text-gray-700 leading-relaxed">{sourceProjects[activeProjectIndex]?.intro}</p>
                                </div>
                                ...
                                <div className="text-center pt-6">
                                        <Link
                                            to={sourceProjects[activeProjectIndex]?.link}
